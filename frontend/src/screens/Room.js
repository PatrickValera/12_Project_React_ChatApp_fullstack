import { Avatar, Box, Paper, styled, Input, Typography, Button, ListItemButton, ListItemIcon, ListItemText, Collapse, List, Menu, MenuItem, Backdrop } from '@mui/material'
        ...
        <>
            <Box className='room-nav' sx={{ p: 4, pt: '50px', backgroundColor: 'primary.main', height: '100%', zIndex: '1' }}>
                ...
                <Paper sx={{ display: 'flex', p: 2, mb: 2, alignItems: 'center' }}>
                    ...
                    >
                        <MenuItem onClick={handleProfile} sx={{ color: 'grey.500', fontWeight: '600' }}>Profile</MenuItem>
